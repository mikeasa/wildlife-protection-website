package com.lecheng.protectAnimals.sessionManager;
...
public class ShiroSession extends DefaultWebSessionManager {
    /**
     * 定义的请求头中使用的AUTH_TOKEN，用来传递 sessionId
     */
    private static final String JSESSIONID= "AUTH_TOKEN";
...
//            request.setAttribute(ShiroHttpServletRequest.REFERENCED_SESSION_ID_IS_VALID, Boolean.TRUE);
            System.out.println("own:"+sessionId);
            return sessionId;
        }
    }
